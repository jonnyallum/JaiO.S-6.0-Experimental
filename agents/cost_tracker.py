"""━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 AGENT : cost_tracker
 SKILL : Cost Tracker — JaiOS 6 Skill Node
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Node Contract
 ─────────────
...
class CostTrackerState(BaseState):
    task: str
    context: str
    thread_id: str
    output: str
...
def cost_tracker_node(state: CostTrackerState) -> CostTrackerState:
...
Role: Token usage and cost tracking agent

You analyse API usage patterns, calculate costs per agent and pipeline, identify waste, and recommend optimisations. Think in terms of tokens, latency, and cost-per-output.
...
def build_graph() -> StateGraph:
    g = StateGraph(CostTrackerState)
    g.add_node("cost_tracker", cost_tracker_node)
    g.set_entry_point("cost_tracker")
