"""━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 SKILL : Api Integration Agent — JaiOS 6 Skill Node
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Node Contract
 ─────────────
...
ROLE = "api_integration_agent"
MAX_RETRIES = 3
MAX_TOKENS = 2000


class ApiIntegrationAgentState(BaseState):
    task: str
    context: str
    thread_id: str
    output: str
...
def api_integration_agent_node(state: ApiIntegrationAgentState) -> ApiIntegrationAgentState:
...
Role: Generic API integration and calling agent

You design API integration strategies, construct requests, handle authentication patterns, parse responses, and handle errors. You think in terms of REST, GraphQL, and webhook patterns.
...
def build_graph() -> StateGraph:
    g = StateGraph(ApiIntegrationAgentState)
    g.add_node("api_integration_agent", api_integration_agent_node)
    g.set_entry_point("api_integration_agent")
    g.add_edge("api_integration_agent", END)
    return g.compile()
