"""
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
AGENT : gcp_ai_specialist
SKILL : Gcp Ai Specialist
...
class GcpAiSpecialistState(BaseState):
    workflow_id:      str
    timestamp:        str
    agent:            str
    error:            str | None
...
def build_graph():
    ...
    g = StateGraph(GcpAiSpecialistState)
    g.add_node("gcp_ai_specialist", gcp_ai_specialist_node)
    g.set_entry_point("gcp_ai_specialist")
    g.add_edge("gcp_ai_specialist", END)
    return g.compile()
