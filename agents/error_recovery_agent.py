"""━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 SKILL : Error Recovery Agent — JaiOS 6 Skill Node
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Node Contract
 ─────────────
...
ROLE = "error_recovery_agent"
MAX_RETRIES = 3
MAX_TOKENS = 2000


class ErrorRecoveryAgentState(BaseState):
    task: str
    context: str
    thread_id: str
    output: str
...
def error_recovery_agent_node(state: ErrorRecoveryAgentState) -> ErrorRecoveryAgentState:
...
Role: Automated error diagnosis and recovery agent

You diagnose errors from stack traces, logs, and context. Classify as transient vs permanent, suggest fixes, and where possible, generate corrective actions automatically.
...
def build_graph() -> StateGraph:
    g = StateGraph(ErrorRecoveryAgentState)
    g.add_node("error_recovery_agent", error_recovery_agent_node)
    g.set_entry_point("error_recovery_agent")
    g.add_edge("error_recovery_agent", END)
    return g.compile()
