...
## Usage
```python
from agents.investment_analyst import investment_analyst_node, build_graph

# Direct node call
result = investment_analyst_node({"task": "your task here", "context": "", "thread_id": "t1"})
...
```
PERSONA_INVESTMENT_ANALYST_NAME="Custom Name"
PERSONA_INVESTMENT_ANALYST_NICKNAME="Custom Nick"
```
