"""━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 AGENT : motogp_analyst
 SKILL : Motogp Analyst — JaiOS 6 Skill Node
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Node Contract
 ─────────────
...
class MotogpAnalystState(BaseState):
    task: str
    context: str
    thread_id: str
    output: str
...
def motogp_analyst_node(state: MotogpAnalystState) -> MotogpAnalystState:
...
Role: MotoGP telemetry, race craft, and betting analysis

You analyse MotoGP: sector times, tyre degradation, wet-weather ability, qualifying form, championship pressure. Convert telemetry insight into race and head-to-head value.
...
def build_graph() -> StateGraph:
    g = StateGraph(MotogpAnalystState)
    g.add_node("motogp_analyst", motogp_analyst_node)
    g.set_entry_point("motogp_analyst")
    g.add_edge("motogp_analyst", END)
    return g.compile()
