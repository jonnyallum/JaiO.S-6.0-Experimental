...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Node Contract
 ─────────────
 Input keys  : match (str), league (str — optional), bet_type (str — match_result/goals/cards/corners)
 Output keys : tactical_report (str), value_bets (str), confidence (str)
 Side effects: Supabase PRE/POST checkpoints, CallMetrics telemetry

 Football tactical intelligence and value betting analysis
...
class FootballTacticalState(TypedDict):
    task: str
    context: str
    thread_id: str
    output: str
...
def football_tactical_node(state: FootballTacticalState) -> FootballTacticalState:
...
Role: Football tactical intelligence and value betting analysis

You analyse football matches tactically: formations, pressing triggers, set-piece threats, key player matchups. Convert tactical edges into betting value.
...
def build_graph() -> StateGraph:
    g = StateGraph(FootballTacticalState)
    g.add_node("football_tactical", football_tactical_node)
    g.set_entry_point("football_tactical")
    g.add_edge("football_tactical", END)
    return g.compile()
