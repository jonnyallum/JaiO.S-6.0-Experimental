...
## Usage
```python
from agents.recruitment_specialist import recruitment_specialist_node, build_graph

# Direct node call
result = recruitment_specialist_node({"task": "your task here", "context": "", "thread_id": "t1"})
...
```
PERSONA_RECRUITMENT_SPECIALIST_NAME="Custom Name"
PERSONA_RECRUITMENT_SPECIALIST_NICKNAME="Custom Nick"
```
