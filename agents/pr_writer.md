...
## Usage
```python
from agents.pr_writer import pr_writer_node, build_graph

# Direct node call
result = pr_writer_node({"task": "your task here", "context": "", "thread_id": "t1"})
...
```
PERSONA_PR_WRITER_NAME="Custom Name"
PERSONA_PR_WRITER_NICKNAME="Custom Nick"
```
