...
## Usage
```python
from agents.system_architect import system_architect_node, build_graph

# Direct node call
result = system_architect_node({"task": "your task here", "context": "", "thread_id": "t1"})
...
```
PERSONA_SYSTEM_ARCHITECT_NAME="Custom Name"
PERSONA_SYSTEM_ARCHITECT_NICKNAME="Custom Nick"
```
