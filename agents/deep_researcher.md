...
## Usage
```python
from agents.deep_researcher import deep_researcher_node, build_graph

# Direct node call
result = deep_researcher_node({"task": "your task here", "context": "", "thread_id": "t1"})
...
```
PERSONA_DEEP_RESEARCHER_NAME="Custom Name"
PERSONA_DEEP_RESEARCHER_NICKNAME="Custom Nick"
```
