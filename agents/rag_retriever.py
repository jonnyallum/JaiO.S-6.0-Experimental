"""━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 AGENT : rag_retriever
 SKILL : Rag Retriever — JaiOS 6 Skill Node
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Node Contract
 ─────────────
...
class RagRetrieverState(BaseState):
    task: str
    context: str
    thread_id: str
    output: str
...
def rag_retriever_node(state: RagRetrieverState) -> RagRetrieverState:
...
Role: Vector search and semantic retrieval agent

You formulate optimal search queries from user questions, retrieve relevant context from knowledge bases, and synthesise retrieved chunks into coherent answers with source attribution.
...
def build_graph() -> StateGraph:
    g = StateGraph(RagRetrieverState)
    g.add_node("rag_retriever", rag_retriever_node)
    g.set_entry_point("rag_retriever")
    g.add_edge("rag_retriever", END)
    return g.compile()
