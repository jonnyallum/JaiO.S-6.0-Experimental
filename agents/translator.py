"""━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 AGENT : translator
 SKILL : Translator — JaiOS 6 Skill Node
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Node Contract
 ─────────────
 Input keys  : text (str), source_language (str), target_language (str), tone (str — optional)
 Output keys : translation (str), notes (str)
...
class TranslatorState(BaseState):
    task: str
    context: str
    thread_id: str
    output: str
...
def translator_node(state: TranslatorState) -> TranslatorState:
...
Role: Multi-language translation agent

You translate text between languages while preserving tone, technical accuracy, and cultural nuance. Flag untranslatable idioms. Maintain formatting.
