...
## Usage
```python
from agents.due_diligence_analyst import due_diligence_analyst_node, build_graph

# Direct node call
result = due_diligence_analyst_node({"task": "your task here", "context": "", "thread_id": "t1"})
...
```
PERSONA_DUE_DILIGENCE_ANALYST_NAME="Custom Name"
PERSONA_DUE_DILIGENCE_ANALYST_NICKNAME="Custom Nick"
```
