"""━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 AGENT : darts_analyst
 SKILL : Darts Analyst — JaiOS 6 Skill Node
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Node Contract
 ─────────────
...
class DartsAnalystState(BaseState):
    task: str
    context: str
    thread_id: str
    output: str
...
def darts_analyst_node(state: DartsAnalystState) -> DartsAnalystState:
...
Role: Darts statistics, averages, and checkout route analysis

You analyse darts matches: 3-dart averages, checkout percentages, head-to-head records, form runs, and venue factors. Identify value in match and leg markets.
...
def build_graph() -> StateGraph:
    g = StateGraph(DartsAnalystState)
    g.add_node("darts_analyst", darts_analyst_node)
    g.set_entry_point("darts_analyst")
    g.add_edge("darts_analyst", END)
    return g.compile()
