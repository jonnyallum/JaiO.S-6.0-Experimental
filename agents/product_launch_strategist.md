...
## Usage
```python
from agents.product_launch_strategist import product_launch_strategist_node, build_graph

# Direct node call
result = product_launch_strategist_node({"task": "your task here", "context": "", "thread_id": "t1"})
...
```
PERSONA_PRODUCT_LAUNCH_STRATEGIST_NAME="Custom Name"
PERSONA_PRODUCT_LAUNCH_STRATEGIST_NICKNAME="Custom Nick"
```
